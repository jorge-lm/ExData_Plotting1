...
plot(electric$Voltage~date_time,type="l",ylab="Voltage",xlab="datetime")


plot(electric$Global_reactive_power~date_time,type="l",ylab="Global reactive power",xlab="datetime")
...
lines(electric$Sub_metering_2~date_time,col="red")
lines(electric$Sub_metering_3~date_time,col="blue")
legend("topright", col=c("black", "red", "blue"), lwd=c(1,1,1),c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"),cex=0.5)
plot(electric$Global_reactive_power~date_time,type="l",ylab="Global reactive power",xlab="datetime")
